...
<ul class="footer-links">
	<li style="display: inline;">&copy; <t:mutiLang langKey="common.copyright"/><a href="#" title="PCI应用平台  <t:mutiLang langKey="system.version.number"/>">PCI应用平台  <t:mutiLang langKey="system.version.number"/></a></li>
	<li style="display: inline;">&nbsp;<t:mutiLang langKey="common.copyright"/><t:mutiLang langKey="common.browser"/>:<a title="PCI应用平台  <t:mutiLang langKey="system.version.number"/>" href="#">PCI应用平台  <t:mutiLang langKey="system.version.number"/></a></li>
</ul>
</div>
</footer>
