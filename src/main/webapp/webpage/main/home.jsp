...
<h3>简介</h3>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PCI应用平台是一款基于代码生成器的快速开发平台，可以减少Java项目80%的重复工作，让开发更多关注业务逻辑。提高开发效率并降低成本。</p>
<h3>适用项目</h3>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PCI应用平台，可以应用在任何J2EE项目的开发中，尤其适合企业信息管理系统（MIS）、内部办公系统（OA）、企业资源计划系统（ERP）、客户关系管理系统（CRM）等。</p>
<h3>架构说明</h3>
<ul>
	<li>PCI应用平台，采用SpringMVC + Hibernate + Minidao(类Mybatis) + Easyui(UI库)+ Jquery + Boostrap + Ehcache + Redis + Ztree等基础架构,采用面向声明的开发模式， 基于泛型编写极少代码即可实现复杂的数据展示、数据编辑、表单处理等功能，再配合代码生成器的使用,将J2EE的开发效率提高6倍以上，可以将代码减少60%以上。</li>
	<li>功能点: <b>1.代码生成器</b> <b>2.数据权限</b> <b>3.Online表单</b> <b>4.工作流组件</b> <b>5.移动OA</b> <b>6.EasyPOI工具类</b> <b>7.查询过滤器</b> <b>8.UI库</b> <b>9.国际化</b> <b>10.多数据源</b> <b>11.自定义表单</b> <b>12.在线报表</b> <b>13.移动报表</b> <b>14.日志监控</b> <b>15.首页切换</b> <b>16.插件开发</b></li>
	...
	<li>[16].业务功能组件以插件方式集成平台，也可以单独部署发发布，有力支撑了SAAS云应用系统需求</li>
	<li>经过专业性能压力测试，保证后台数据的准确性和页面访问速度</li>
